...
void DrawGrid(HWND hwnd, HDC hdc, PAINTSTRUCT ps) {
...
//    GrLine(hwnd,hdc,ps,Grid[i].x1,Grid[i].y1,Grid[i].x2,Grid[i].y1,RGB(255,255,255));
//    GrLine(hwnd,hdc,ps,Grid[i].x1,Grid[i].y1,Grid[i].x1,Grid[i].y2,RGB(255,255,255));
